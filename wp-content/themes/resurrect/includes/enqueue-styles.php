...
function resurrect_enqueue_styles() {
	...
	wp_enqueue_style( 'elusive-webfont', ctfw_theme_url( CTFW_THEME_CSS_DIR . '/elusive-webfont.css' ), false, CTFW_THEME_VERSION );  // bust cache on theme update
	...
	wp_enqueue_style( 'resurrect-responsive', ctfw_theme_url( CTFW_THEME_CSS_DIR . '/responsive.css' ), false, CTFW_THEME_VERSION );  // bust cache on theme update
