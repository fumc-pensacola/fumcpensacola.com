...
jQuery( document ).ready( function( $ ) {
	...
	$( '#customize-control-background_image .library-content[data-customize-tab="ctfw_presets"] a[data-customize-image-value]' ).click( function() {
		...
		if ( repeat.length) $( "input[name=_customize-radio-background_repeat][value=" + repeat + "]" ).prop( 'checked', true ).trigger( 'change' ); // trigger change for preview
		if ( position.length) $( "input[name=_customize-radio-background_position_x][value=" + position + "]" ).prop( 'checked', true ).trigger( 'change' ); // trigger change for preview
		if ( attachment.length) $( "input[name=_customize-radio-background_attachment][value=" + attachment + "]" ).prop( 'checked', true ).trigger( 'change' ); // trigger change for preview
