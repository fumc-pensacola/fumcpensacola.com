...
<footer class="resurrect-entry-footer resurrect-clearfix">
	...
	<ul class="resurrect-entry-footer-item resurrect-list-buttons">
		...
		if ( $directions_url ) :
			?><li><a href="<?php echo esc_url( $directions_url ); ?>" target="_blank"><span class="resurrect-button-icon <?php resurrect_icon_class( 'location-directions' ); ?>"></span><?php _e( 'Directions', 'resurrect' ); ?></a></li><?php
		endif;
	...
	<ul class="resurrect-entry-footer-item resurrect-list-buttons">
		...
		if ( $directions_url ) :
			?><li><a href="<?php echo esc_url( $directions_url ); ?>" target="_blank"><span class="resurrect-button-icon <?php resurrect_icon_class( 'event-directions' ); ?>"></span><?php _e( 'Directions', 'resurrect' ); ?></a></li><?php
		endif;
